...
enum AcoreStrings
{
    ...
    // Custom Item (only used IDs kept, ordered by entry)
        ...
        LANG_ITEM_VIP_MENU = 12208,
        LANG_ITEM_CLOSE = 12209,
        LANG_ITEM_COMMAND_LIST = 12210,
        LANG_ITEM_CHARACTER_MANAGEMENT = 12211,
        LANG_ITEM_CHARACTER_CHANGEING = 12212,
        LANG_ITEM_REPAIR_EQUIP = 12213,
        LANG_ITEM_REMOVE_DESERTER = 12214,
        LANG_ITEM_REMOVE_WEAKNESS = 12215,
        LANG_ITEM_GIVE_BUFFS = 12216,
        LANG_ITEM_REMOVE_COOLDOWN = 12217,
        LANG_ITEM_DUAL_SPEC = 12218,
        LANG_ITEM_RESET_TALENT = 12219,
        LANG_ITEM_RESET_TALENT_SURE = 12220,
        LANG_ITEM_SKILLS_WEAPON = 12221,
        LANG_ITEM_MAXSKILL = 12222,
        LANG_ITEM_TALENT_RESET_CONFIRM = 12223,
        LANG_ITEM_SKILLS_WEAPON_CONFIRM = 12224,
        LANG_ITEM_MAXSKILL_CONFIRM = 12225,
        LANG_ITEM_REPAIR_CONFIRM = 12226,
        LANG_ITEM_DESERTER_NOT_FOUND = 12227,
        LANG_ITEM_DESERTER_REMOVED = 12228,
        LANG_ITEM_CHANGE_NAME = 12229,
        LANG_ITEM_CHANGE_OF_APPEARANCE = 12230,
        LANG_ITEM_CHANGE_FACTION = 12231,
        LANG_ITEM_CHANGE_RACE = 12232,
        LANG_NOT_USED_BG = 12233,
        LANG_ITEM_NOT_USED_STEALTH = 12234,
        LANG_ITEM_NOT_USED_DEAD = 12235,
        LANG_ITEM_VIP_BANK = 12236,
        LANG_ITEM_RESTORE_HP_MANA = 12237,
        LANG_ITEM_RESET_SAVED_INSTANCES = 12238,
        LANG_ITEM_MSG_RESTORE_HP_MANA = 12239,
        LANG_ITEM_MSG_RESET_SAVED_INSTANCES = 12240,
        LANG_ITEM_ERROR_IN_COMBAT = 12241,
        LANG_ITEM_ERROR_IN_FLIGHT = 12242,
        LANG_ITEM_ERROR_IN_BG = 12243,
        LANG_ITEM_TELEPORT_MENU = 12244,
        LANG_ITEM_BACK_TO_MAIN_MENU = 12245,
        LANG_ITEM_TELEPORT_SUCCESS = 12246,
        LANG_ITEM_PREMIUM_UNKNOWN_ITEM = 12247,
        LANG_ITEM_PREMIUM_EXTENDED = 12248,
        LANG_ITEM_PREMIUM_ACTIVATED = 12249,

        // Vip Commands
        LANG_PLAYER_NOT_VIP = 30100,
        LANG_VIP_COMMAND_DISABLED = 30101,
        LANG_VIP_ERROR = 30102,
        LANG_VIP_BG = 30103,
        LANG_VIP_STEALTH = 30104,
        LANG_VIP_DEAD = 30105,
        LANG_VIP_CHANGE_RACE = 30106,
        LANG_VIP_CHANGE_CUSTOMIZE = 30107,
        LANG_VIP_GROUP = 30108,
        LANG_PLAYER_TARGET_NOT_VIP = 30109,
        LANG_PLAYER_VIP_TIME_EXIST = 30110,
        LANG_PLAYER_VIP_TIME_NEAR_END = 30111,
        LANG_PLAYER_VIP_TIME_EXPIRED = 30112,
        LANG_TARGETPLAYER_VIP_TIME_EXIST = 30113,
        LANG_PINFO_CHR_VIP_MODE = 12001,
        LANG_VIP_IN_DEVELOPMENT = 12184,

        // Rank System
        LANG_RANK_GLORY_WIN_1 = 30200,  // PVP_HK
        LANG_RANK_GLORY_WIN_2 = 30201,  // PVP_BG
        LANG_RANK_GLORY_WIN_3 = 30202,  // PVP_ARENA
        LANG_RANK_GLORY_WIN_4 = 30203,  // default
        LANG_RANK_GLORY_WIN_5 = 30204,  // with format: amount, rankInfoStr, PointsUntilNextRank()
        LANG_RANK_GLORY_WIN_6 = 30205,  // with format: GetRankPoints(), GetRankByExp(), PointsUntilNextRank()
        LANG_RANK_GLORY_WIN_7 = 30206,  // PVP_QUEST
        LANG_RANK_GLORY_WIN_8 = 30207,  // PVP_ITEM
        LANG_RANK_GLORY_WIN_10 = 30208,
        LANG_RANK_GLORY_WIN_11 = 30209,  // PVP_KILL
        LANG_RANK_GLORY_WIN_12 = 30210,  // PVE_ACHIV
        LANG_RANK_GLORY_WIN_13 = 30211,
        LANG_RANK_GLORY_WIN_14 = 30212,  // EXCHANGER_HONOR
        LANG_RANK_MONEY_QUEST_WIN = 30213,  // RU_MRQW, EN_MRQW
        LANG_RANK_MONEY_ARENA_2V2_WIN = 30214,  // RU_MR2W, EN_MR2W
        LANG_RANK_MONEY_ARENA_2V2_LOSE = 30215,  // RU_MR2E, EN_MR2E
        LANG_RANK_MONEY_ARENA_3V3_WIN = 30216,  // RU_MR3W, EN_MR3W
        LANG_RANK_MONEY_ARENA_3V3_LOSE = 30217,  // RU_MR3E, EN_MR3E
        LANG_RANK_MONEY_BG_WIN = 30218,  // RU_MRBGW, EN_MRBGW
        LANG_RANK_MONEY_BG_LOSE = 30219,  // RU_MRBGE, EN_MRBGE
        LANG_RANK_MONEY_ARENA_1V1_5V5_WIN = 30220,  // RU_MR1W, EN_MR1W
        LANG_RANK_MONEY_ARENA_1V1_5V5_LOSE = 30221,  // RU_MR1E, EN_MR1E
        LANG_RANK_MONEY_KILL = 30222,  // RU_MRKILL, EN_MRKILL
        LANG_RANK_EQUIP_REQUIRED = 30223,  // RU_equipe_rank, EN_equipe_rank
        LANG_RANK_VENDOR_GREETING = 30224,  // Vendor greeting
        LANG_RANK_VENDOR_DESCRIPTION = 30225,  // Vendor description with rank range
        LANG_RANK_VENDOR_NO_RANK = 30226,  // Need to increase rank message
        LANG_RANK_VENDOR_GOODBYE = 30227,  // Goodbye message
        LANG_RANK_VENDOR_REFRESH = 30228,  // Refresh menu
        LANG_RANK_VENDOR_RANK_ITEM = 30229,  // Rank item text
        LANG_RANK_INFO_HEADER = 30230,  // Rank info header
        LANG_RANK_INFO_CURRENT = 30231,  // Current rank
        LANG_RANK_INFO_POINTS = 30232,  // Rank points
        LANG_RANK_INFO_NEXT_RANK = 30233,  // Points until next rank
        LANG_RANK_INFO_MAX_RANK = 30234,  // Maximum rank reached
        LANG_RANK_INFO_PINFO_CURRENT = 30235,  // Rank info in pinfo
        LANG_RANK_TOP_HEADER = 30236,  // Rank top header
        LANG_RANK_TOP_ENTRY = 30237,  // Rank top entry
        LANG_RANK_STATS_HEADER = 30238,  // Rank stats header
        LANG_RANK_STATS_SOURCE = 30239,  // Rank stats source
        LANG_RANK_STATS_TOTAL = 30240,  // Rank stats total
        LANG_RANK_SYSTEM_MENU = 30241,  // Rank System menu item
