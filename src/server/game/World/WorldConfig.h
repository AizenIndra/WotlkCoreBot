...
enum ServerConfigs
{
    ...
    CONFIG_SHOP_ENABLE,
    CONFIG_VIP_DEBUFF,
    CONFIG_VIP_DEBUFF_SPELL,
    CONFIG_VIP_BUFF,
    CONFIG_VIP_BUFF_SPELLS,
    CONFIG_VIP_BANK,
    CONFIG_VIP_MAIL,
    CONFIG_VIP_REPAIR,
    ...
    RATE_VIP_XP_KILL,
    RATE_VIP_XP_QUEST,
    RATE_VIP_XP_QUEST_DF,
    RATE_VIP_XP_EXPLORE,
    RATE_VIP_HONOR,
    RATE_VIP_REPUTATION,
    RATE_VIP_RANK_REWARD,
    ...
    CONFIG_ANTICHEAT_CLIMBHACK_ENABLED,
    CONFIG_ANTICHEAT_CLIMBHACK_KICK_ENABLED,
    CONFIG_ANTICHEAT_SPEEDHACK_KICK_ENABLED,
    CONFIG_ANTICHEAT_FLYHACK_KICK_ENABLED,
    CONFIG_ANTICHEAT_FAKEJUMPER_KICK_ENABLED,
    CONFIG_ANTICHEAT_FAKEFLYINGMODE_KICK_ENABLED,
    CONFIG_ANTICHEAT_NOFALLINGDMG_KICK_ENABLED,
    CONFIG_ANTICHEAT_TELEPORT_SEGMENT_ENABLED,
    CONFIG_ANTICHEAT_TELEPORT_SEGMENT_KICK_ENABLED,
    CONFIG_ANTICHEAT_WATERWALK_ENABLED,
    CONFIG_ANTICHEAT_WATERWALK_KICK_ENABLED,
    CONFIG_ANTICHEAT_MEGAJUMP_ENABLED,
    CONFIG_ANTICHEAT_MEGAJUMP_KICK_ENABLED,
    CONFIG_ANTICHEAT_FLYHACK_TIMER,
    CONFIG_ANTICHEAT_TELEPORT_MAX_SEGMENT_YARDS,
    CONFIG_ANTICHEAT_MEGAJUMP_BASE_ZSPEED,
    CONFIG_ANTICHEAT_MEGAJUMP_ZSPEED_TOLERANCE_MULT,
    CONFIG_ANTICHEAT_AREA_ID_EXCLUDES,
